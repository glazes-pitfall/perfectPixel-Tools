...
Plans:
- [ ] 07-01-PLAN.md — web_ui.html「在编辑器中打开」按钮 + editor.html sessionStorage 握手 + 拖拽上传界面
- [ ] 07-02-PLAN.md — Canvas Size 工具（S 键、六参数顶栏、参考线绘制、像素搬运 Apply）
- [ ] 07-03-PLAN.md — 下载弹窗（整数倍缩放、预览图、Home 按钮）+ Phase 7 目视验证检查点
