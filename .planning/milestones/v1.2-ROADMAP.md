...
- [x] **Phase 7: Integration** - Canvas Size tool, Open-in-Editor entry point, and download/save wiring (completed 2026-03-04)
...
- [ ] 06-04-PLAN.md — Bug 修复 Wave 4：缩放锚点、画布缩放同步、画布外拖回
- [ ] 06-05-PLAN.md — 角手柄缩放/旋转双模式（外圈 RotSprite 旋转）+ 目视验证检查点
...
**Depends on**: Phase 6
**Requirements**: ENTRY-01, CANVAS-03, CFG-01, CFG-02, CFG-03, CFG-04
**Note**: UI-03 was deferred — Phase 4.1 removed palette-result-panel (non-destructive preview panel), making UI-03 incompatible with the destructive apply-to-canvas design direction. See REQUIREMENTS.md for details.
**Success Criteria** (what must be TRUE):
...
Plans:
- [x] 07-01-PLAN.md — web_ui.html「在编辑器中打开」按钮 + editor.html sessionStorage 握手 + 拖拽上传界面
- [x] 07-02-PLAN.md — Canvas Size 工具（S 键、六参数顶栏、参考线绘制、像素搬运 Apply）
- [x] 07-03-PLAN.md — 下载弹窗（整数倍缩放、预览图、Home 按钮）+ Phase 7 目视验证检查点
...
| 7. Integration | 3/3 | Complete | 2026-03-04 |
